        ...
        <Container>
          <div>
            <form className={`py-9 px-24 rounded-lg shadow-xl w-full sm:px-9`} action=''>
              <div className={`flex justify-between items-center`}>
                <div>
                  <h1 className={`font-bold text-3xl`}>Daftar Akun</h1>
                  <h6 className={`text-lg mt-6 mb-9`}>Buat akun untuk memasang acara</h6>
                </div>
              </div>
              <div className={`mb-9`}>
              ...
              <div className={`mb-9`}>
                <h1 className={`font-bold text-xl mb-5`}>Nama Lengkap</h1>
                <input
                  required
                  className={`py-2 w-full px-4 text-lg rounded border-2 border-gray-200 focus:outline-none focus:border-2 focus:border-green-400`}
                  type='text'
              ...
              <div>
                <button className={`bg-green-400 rounded-md py-2 text-base text-white block w-full`} type='submit'>
                  Buat Akun
                </button>
                <h6 className={`text-lg text-center mt-6`}>
                  Sudah memiliki akun?
                  <Link href='/login'>
                    <span className={`text-green-400 underline cursor-pointer`}> Masuk</span>
                  </Link>
                </h6>
              </div>
            </form>
